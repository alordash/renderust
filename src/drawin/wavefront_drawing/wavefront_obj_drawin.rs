use crate::{
    drawin::{drawable::Drawable, color::Color},
    geometry::{primitives::discrete_line::DiscreteLine, primitives::{discrete_point::DiscretePoint, polygons::discrete_triangle::DiscreteTriangle}, rect_size::RectSize},
...
impl Drawable for WavefrontObj {
    ...
    fn fill(&self, canvas: &mut crate::drawin::draw_buffer::DrawBuffer, color: &crate::drawin::color::Color) {
        let RectSize { width, height } = canvas.get_size();
